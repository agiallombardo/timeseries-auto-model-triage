...
def grid_search_lstm_features(X_train, X_test, y_train, y_test, loss='l2'):
    ...
    if results:
        pd.DataFrame(results).sort_values('rmse').to_csv('lstm_feat_grid_search_results.csv', index=False)
